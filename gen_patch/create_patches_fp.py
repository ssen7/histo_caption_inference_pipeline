# ref: https://github.com/mahmoodlab/CLAM/blob/master/create_patches_fp.py
# internal imports
...
def patch_one_wsi(wsi_full_path, save_dir,
	...
	if os.path.exists(os.path.join(save_dir, 'patches', f'{slide_id}.h5')):
